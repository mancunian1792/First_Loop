 ...
 * @return <Object>
 */
export function linkState(statePath: string): ILinkedState {

	let state = this.state,
		parts = statePath.split('.'),
		nameSpace = parts.shift(),
		value = state[nameSpace],
		getNewValuePath: Function;
	...
	// 		}
	// 	}
	getNewValuePath = function(newVal: any): any {
		var constructedObj: any = {},
			internalPtr: any;
